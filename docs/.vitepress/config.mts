...
export default defineConfig({
  base: pagesBase,
  head: [
    // Favicons — single boxed brand icon (same on light + dark tabs), .ico fallback,
    // apple-touch webclip + PWA icons. Same set on the marketing site (Webflow) and dashboard.
    ["link", { rel: "icon", type: "image/png", sizes: "32x32", href: `${pagesBase}favicon-32.png` }],
